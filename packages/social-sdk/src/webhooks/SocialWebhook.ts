...
export type SocialWebhookEvent =
  | (BaseSocialWebhookEvent<WebhookVerifiedData> & { eventType: 'WEBHOOK_VERIFIED' })
  | (BaseSocialWebhookEvent<PublicationCreatedData> & { eventType: 'PUBLICATION_CREATED' })
  | (BaseSocialWebhookEvent<PublicationUpdatedData> & { eventType: 'PUBLICATION_UPDATED' })
  | (BaseSocialWebhookEvent<CommentReceivedData> & { eventType: 'COMMENT_RECEIVED' })
  | (BaseSocialWebhookEvent<MessageReceivedData> & { eventType: 'MESSAGE_RECEIVED' })
  | (BaseSocialWebhookEvent<ReactionAddedData> & { eventType: 'REACTION_ADDED' });
