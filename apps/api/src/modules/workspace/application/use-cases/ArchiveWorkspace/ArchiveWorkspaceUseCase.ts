...
import { ArchiveWorkspaceCommand } from './ArchiveWorkspaceCommand';

export class ArchiveWorkspaceUseCase implements IUseCase<ArchiveWorkspaceCommand, void> {
  constructor(
    private readonly workspaceRepository: IWorkspaceRepository,
    private readonly eventBus: IEventBus
  ) {}

  public async execute(command: ArchiveWorkspaceCommand): Promise<void> {
